...
export async function createTrust(title, description, period, beneficiaries) {
  ...
  const result = await currentContract.createTrust(
    beneficiaries,
    description,
    title,
    period,
...
export async function updateMyTrustBeneficiaries(indexes, beneficiaries) {
  ...
  const result = await currentContract.updateMyTrustBeneficiaries(
    indexes,
    beneficiaries
  );
...
export async function addToMyTrustBeneficiaries(indexes, beneficiaries) {
  ...
  const result = await currentContract.addToMyTrustBeneficiaries(
    indexes,
    beneficiaries
  );
